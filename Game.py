...
apfelCoords = []
richtung = 0 # 0 up 1 right 2 left 3 down 
...
def zeichner():
    ...
    for x in schlange:
        ...
        if kopf:
            ...
            kopf = False
        else:pygame.draw.rect(screen, (47,79,79), (Coords[0],Coords[1],partikel,partikel), 0)
...
while go:
    ...
    if ende == False:
        ...
        print("Du hast " + str(score) + " Punkte ereicht")
        sys.exit()
    clock.tick(10) #Zeit ( Bewegungs Tempo)
